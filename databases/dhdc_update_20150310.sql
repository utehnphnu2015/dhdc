...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` EVENT `event1` ON SCHEDULE EVERY 1 DAY STARTS '2015-03-02 04:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
