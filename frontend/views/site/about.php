...
<div class="site-about">
    ...
    <p>- <?= Html::a('คุณศรศักดิ์ สีหะวงษ์', 'https://fb.com/sosplk', ['target' => '_blank']) ?> (สสจ.พิษณุโลก) Co-Programmer</p>
    <p>- <?= Html::a('คุณภศล สุริยะ', 'https://www.facebook.com/chondlatitsuriya', ['target' => '_blank']) ?> (รพ.ชาติตระการ จ.พิษณุโลก) Custom-Report</p>
