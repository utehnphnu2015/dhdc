...
$this->params['breadcrumbs'][] = 'จำนวนผู้ปกครองเด็กอายุ 0-2 ปีได้รับคำแนะนำและฝึกแปรงฟันให้เด็ก';
?>
...
echo \kartik\grid\GridView::widget([
    ...
    'panel' => [
        ...
        'after' => 'โดย ' . $dev .' update 07/4/2558'
    ],
    ...
    'columns' => [
        ...
        [
            'attribute' => 'target',
            'header' => 'เด็กอายุ 0-2ปี (คน)'
        ],
        [
            'attribute' => 'result',
            'header' => 'ได้คำแนะนำและสอนแปรงฟัน(คน)'
        ],
        [
